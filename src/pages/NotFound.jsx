...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-void px-6 relative">
      ...
      <div className="absolute top-[-300px] right-[-200px] w-[800px] h-[800px] bg-[radial-gradient(circle,var(--color-cyan-glow)_0%,transparent_60%)] pointer-events-none" />
      ...
      <div className="relative z-10 text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-3">
          <Link to="/dashboard" className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan/90 to-cyan/70 text-void text-[14px] font-semibold glow-sm hover:-translate-y-px active:scale-[0.98] transition-all">
