              ...
              {selectedHistory.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={selectedHistory}>
                    ...
                    <XAxis dataKey="date" tick={{fontSize:10,fill:isDark?'#475569':'#64748B',fontFamily:'JetBrains Mono'}} tickLine={false} axisLine={false} interval={Math.floor(selectedHistory.length/6)} tickFormatter={v=>new Date(v).toLocaleDateString('en-US',{month:'short',day:'numeric'})} />
